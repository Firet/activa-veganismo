...
export default function AboutUs() {
	return (
		<section
			id="about-us"
			className="grid md:grid-cols-1 lg:grid-cols-2 about-us-section"
		>
			...
			<div className="p-10 md:pt-10">
				...
				<p className="about-us-text sm:text-sm lg:text-base xg:text-base">
					Un grupo de gente apasionada con muchas ganas de ayudar.
					Creemos en la liberacion animal y en la justicia social.
					Nuestro objetivo es crear puentes entre personas con
					recursos y ganas de ayudar, con espacios que lo necesitan.
				</p>
			</div>
		</section>
	);
